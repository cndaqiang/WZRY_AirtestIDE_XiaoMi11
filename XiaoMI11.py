...
#可以这样命令行中运行
'''
(base) cndaqiang@macmini mac$ /Applications/AirtestIDE.app/Contents/Resources/plugins/firebase_plugin/tool/copy_app/airtest/core/android/static/adb/mac/adb devices
List of devices attached
adb server version (40) doesn't match this client (39); killing...
* daemon started successfully *
8553e6ac	device

(base) cndaqiang@macmini mac$ /Applications/AirtestIDE.app/Contents/Resources/plugins/firebase_plugin/tool/copy_app/airtest/core/android/static/adb/mac/adb tcpip 5555
...
参战英雄=Template(r"tpl1686547383295.png", record_pos=(-0.111, 0.024), resolution=(2400, 1080))



参战英雄线路 =Template(r"tpl1686471287285.png", record_pos=(0.183, -0.21), resolution=(2400, 1080))



备战英雄 =Template(r"tpl1686471251920.png", record_pos=(-0.045, -0.064), resolution=(2400, 1080))
 # `对战` -> `5v5 王者峡谷` -> `人机` -> `开始练习` -> `开始匹配` -> `英雄页面选择你想用的备选英雄`

备战英雄线路 = Template(r"tpl1686471268774.png", record_pos=(0.068, -0.209), resolution=(2400, 1080))
...
def 进入房间(times=1):
    ...
    if not existsTHENtouch(Template(r"tpl1685425252726.png", record_pos=(-0.08, 0.106), resolution=(2400, 1080)),"对战",savepos=True):
        logger.error("选择对战失败")
        进入房间(times); return
    sleep(2)
